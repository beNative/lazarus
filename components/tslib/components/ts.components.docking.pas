...
type
  ...
  private
    ...
    FOnActivateSite: TNotifyEvent; // TS
  ...
  protected
    ...
    procedure DoActivateSite; dynamic;
...
begin
  ...
  FPages.Page[NewIndex].DoubleBuffered := True;
  NewSite.Align:=alClient;
  NewSite.DoubleBuffered := True;
...
procedure TAnchorDockHostSite.DoActivateSite;
begin
  if Assigned(FOnActivateSite) then
    FOnActivateSite(Self);
end;
...
begin
  Result:=(SiteType<>adhstLayout)
      ...
      and Assigned(DockMaster) // Added by TSI
