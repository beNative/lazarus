...

{
  ...
  Changes by Tim Sinaeve:
    ...
    - Added <SHIFT>-<CTRL>-<+> shortcut to auto resize all columns for all
      visible rows to mimick windows listview behaviour.
  ...
  Changes made for the Lazarus port:
    - Removed BorderStyle property (exists in ancestor class).
    - Removed Ctl3D/ParentCtl3D
    - Removed Height and Width initializations (these triggered a lot of
      unwanted events) => !? TSI

  KNOWN ISSUES:
    - TCanvas.BrushCopy not implemented (yet) in Lazarus (Graphics.pas)
    - Flat scrollbars not supported
    - TControl.SendCancelMode not implemented (yet) in Lazarus
}

unit ts_Components_GridView;
...
{ TGridHeaderSections }
{
  ...
  public
    constructor Create(AHeader       : TCustomGridHeader;
                       AOwnerSection : TGridHeaderSection); virtual;
...
{ TCustomGridView }
{
  ...
  Procedures:
    ...
    FlatScrollBars -       to reflect the flat scrollers (only dyal
                           comctrl32.dll version 4.71 are above).
  ...
  TGridAppendRowEvent = procedure(Sender: TObject; var Append: Boolean)
    of object;

  TGridTextEvent = procedure(Sender: TObject; Cell: TGridCell;
    var Value: string) of object;
  TGridRectEvent = procedure(Sender: TObject; Cell: TGridCell; var Rect: TRect)
    of object;
  TGridCellColorsEvent = procedure(Sender: TObject; Cell: TGridCell;
    Canvas: TCanvas) of object;
  TGridCellImageEvent = procedure(Sender: TObject; Cell: TGridCell;
    var ImageIndex: Integer) of object;
  TGridCellClickEvent = procedure(Sender: TObject; Cell: TGridCell;
    Shift: TShiftState; X, Y: Integer) of object;
  TGridCellAcceptCursorEvent = procedure(Sender: TObject; Cell: TGridCell;
    var Accept: Boolean) of object;
  TGridCellNotifyEvent = procedure(Sender: TObject; Cell: TGridCell) of object;
  TGridCellIndentEvent = procedure(Sender: TObject; Cell: TGridCell;
    var Indent: TPoint) of object;
  TGridCellTipsEvent = procedure(Sender: TObject; Cell: TGridCell;
    var AllowTips: Boolean) of object;
  TGridCellReadOnlyEvent = procedure(Sender: TObject; Cell: TGridCell;
    var CellReadOnly: Boolean) of object;
  TGridHeaderColorsEvent = procedure(Sender: TObject;
    Section: TGridHeaderSection; Canvas: TCanvas) of object;
  TGridHeaderImageEvent = procedure(Sender: TObject;
    Section: TGridHeaderSection; var ImageIndex: Integer) of object;
  TGridDrawEvent = procedure(Sender: TObject; var DefaultDrawing: Boolean)
    of object;
  TGridDrawCellEvent = procedure(Sender: TObject; Cell: TGridCell;
    var Rect: TRect; var DefaultDrawing: Boolean) of object;
  TGridDrawHeaderEvent = procedure(Sender: TObject; Section: TGridHeaderSection;
    Rect: TRect; var DefaultDrawing: Boolean) of object;
  TGridDrawHeadersEvent = procedure(Sender: TObject; DrawFixed: Boolean;
    var DefaultDrawing: Boolean) of object;
  TGridDrawHeaderSectionsEvent = procedure(Sender: TObject;
    Sections: TGridHeaderSections; AllowFixed: Boolean;
    var DefaultDrawing: Boolean) of object;
  TGridColumnResizeEvent = procedure(Sender: TObject; Column: Integer;
    var Width: Integer) of object;
  TGridHeaderClickEvent = procedure(Sender: TObject;
    Section: TGridHeaderSection) of object;
  TGridHeaderClickingEvent = procedure(Sender: TObject;
    Section: TGridHeaderSection; var AllowClick: Boolean) of object;
  TGridChangingEvent = procedure(Sender: TObject; var Cell: TGridCell;
    var Selected: Boolean) of object;
  TGridChangedEvent = procedure(Sender: TObject; Cell: TGridCell;
    Selected: Boolean) of object;
  TGridEditStyleEvent = procedure(Sender: TObject; Cell: TGridCell;
    var Style: TGridEditStyle) of object;
  TGridEditListEvent = procedure(Sender: TObject; Cell: TGridCell;
    Items: TStrings) of object;
  TGridEditCloseUpEvent = procedure(Sender: TObject; Cell: TGridCell;
    ItemIndex: Integer; var Accept: Boolean) of object;
  TGridEditCanModifyEvent = procedure(Sender: TObject; Cell: TGridCell;
    var CanModify: Boolean) of object;
  TGridEditCanShowEvent = procedure(Sender: TObject; Cell: TGridCell;
    var CanShow: Boolean) of object;
  TGridAcceptKeyEvent = procedure(Sender: TObject; Cell: TGridCell; Key: Char;
    var Accept: Boolean) of object;
  TGridCheckKindEvent = procedure(Sender: TObject; Cell: TGridCell;
    var CheckKind: TGridCheckKind) of object;
  TGridCheckStateEvent = procedure(Sender: TObject; Cell: TGridCell;
    var CheckState: TCheckBoxState) of object;
  TGridCheckImageEvent = procedure(Sender: TObject; Cell: TGridCell;
    CheckImage: TBitmap) of object;
  TGridCheckAlignmentEvent = procedure(Sender: TObject; Cell: TGridCell;
    var CheckAlignment: TAlignment) of object;
  TGridSortDirectionEvent = procedure(Sender: TObject;
    Section: TGridHeaderSection; var SortDirection: TGridSortDirection)
    of object;
  TGridSortImageEvent = procedure(Sender: TObject; Section: TGridHeaderSection;
    SortImage: TBitmap) of object;
  ...
  private
    ...
    procedure HorzScroll(Sender: TObject; ScrollCode: Integer;
    ...
    procedure VertScroll(Sender: TObject; ScrollCode: Integer;
      var ScrollPos: Integer);
    ...
    procedure WMChar(var Msg: TLMChar); message WM_CHAR;
  ...
  protected
    ...
    procedure CellClick(Cell: TGridCell; Shift: TShiftState;
      X, Y: Integer); virtual;
    ...
    function CreateHeaderSection(Sections: TGridHeaderSections)
      : TGridHeaderSection; virtual;
    procedure CreateParams(var Params: TCreateParams); override;
    ...
    function GetCellImageRect(Cell: TGridCell): Classes.TRect; virtual;
  ...
  public
    ...
    procedure DefaultDrawHeader(Section: TGridHeaderSection;
      Rect: TRect); virtual;
    procedure DefaultDrawHeaders(DrawFixed: Boolean); virtual;
    procedure DefaultDrawHeaderSections(Sections: TGridHeaderSections;
      AllowFixed: Boolean);
    ...
    function GetColumnMaxWidth(Column: Integer; IncludeTitles: Boolean = False;
      OnlyVisibleRows: Boolean = True): Integer; virtual;
    ...
    property AllowSelect: Boolean read FAllowSelect write SetAllowSelect
      default True;
    property AlwaysEdit: Boolean read FAlwaysEdit write SetAlwaysEdit
      default False;
    property AlwaysSelected: Boolean read FAlwaysSelected
      write SetAlwaysSelected default False;
...
function TGridHeaderSection.GetBoundsRect: Classes.TRect;
begin
...
procedure TGridHeaderSections.SetSection(Index: Integer;
  Value: TGridHeaderSection);
begin
...
// TSI: does not exist in Delphi version !!!
...
begin
  ...
  if AMax < AMin then
    AMax := AMin;
  {it did change that nibud'}
  if (FMin <> AMin) or (FMax <> AMax) or (FPageStep <> APageStep) or
    (FLineStep <> ALineStep) then
  begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        ScrollWindowEx(Handle, (FPosition - Value) * FLineSize, 0, @R, @R, 0,
          nil, SW_INVALIDATE);
      end
      else
      begin
        R := GetGridRect;
        ScrollWindowEx(Handle, 0, (FPosition - Value) * FLineSize, @R, @R, 0,
          nil, SW_INVALIDATE);
      end;
      FPosition :=  Value;
      ShowFocus;
...
procedure TGridListBox.MouseUp(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
...
procedure TCustomGridEdit.ListMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
function TCustomGridEdit.DoMouseWheel(Shift: TShiftState; WheelDelta: Integer;
...
begin
  if Grid <> nil then
  begin
    { send away key to table}
    Grid.KeyPress(Key);
    { check the accessibility of symbol}
...
procedure TCustomGridEdit.MouseDown(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
  { check pressure on the button}
  if (Button = mbLeft) and (EditStyle <> geSimple) and
    PtInRect(ButtonRect, Classes.Point(X, Y)) then
  begin
    { do see list}
...
procedure TCustomGridEdit.MouseUp(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
var
  P: Boolean;
begin
...
begin
  if (Grid = nil) or (FActiveList = nil) or
    (not(FActiveList is TGridListBox)) then
    Exit;
...
const
  Flags = SWP_NOZORDER or SWP_NOMOVE or SWP_NOSIZE or SWP_NOACTIVATE or
    SWP_HIDEWINDOW;
begin
  if FDropListVisible then
  begin
...
procedure TGridTipsWindow.ActivateHintData(Rect: TRect; const AHint: string;
  AData: Pointer);
begin
  FGrid := AData;
...
function TGridTipsWindow.CalcHintRect(MaxWidth: Integer; const AHint: string;
  AData: Pointer): TRect;
var
  R: TRect;
begin
...
procedure TCustomGridView.LMPaint(var Message: TLMPaint);
var
  DC, MemDC: HDC;
...
begin
  ...
  begin
    ...
    try
      ...
      BitBlt(DC, 0, 0, ClientRect.Right, ClientRect.Bottom, MemDC, 0,
        0, SRCCOPY);
      EndPaint(Handle, PS);
    finally
...
begin
  ...
  begin
    ...
    InflateRect(R, 1, 1);
    CursorRect := R;
    {the type of the window of prompt}
...
begin
  Result := True;
  {is it possible to establish focus}
...
begin
  ResetClickPos;
  { establish text and we dissipate the line of editing}
...
begin
  ...
  if [csReading, csLoading, csDesigning, csDestroying] * ComponentState
    <> [] then
  begin
    Result := False;
    Exit;
...
function TCustomGridView.GetCellImageRect(Cell: TGridCell): Classes.TRect;
var
  R: Classes.TRect;
begin
...
begin
  ...
  { consider pictures even 3D effect}
...
function TCustomGridView.GetCursorCell(Cell: TGridCell;
  ...
  begin
    ...
    begin
      ...
      begin
        C := GridCell(I, J);
        if IsCellAcceptCursor(C) and
          ((not RowSelect) or (C.Row <> Cell.Row)) then
        begin
          Result := C;
          Exit;
        end;
...
begin
  ...
  AllowClick := ColumnClick and Section.AllowClick and
...
begin
  ...
  if (gkTabs in CursorKeys) and (Key = VK_TAB) then
    SetCursor(GetCursorCell(CellFocused, TabOffsets[ssShift in Shift]),
      True, True);
...
{$IFDEF EX_D7_UP}
  if FThemeXPEnabled and ThemeServices.ThemesEnabled then
  begin
...
begin
  ...
  begin
    Result := ReadOnly or (Cell.Col < Fixed.Count) or Columns[Cell.Col]
      .ReadOnly;
...
begin
// TS:!!!this was not needed in Delphi
...
var
  R, P, L: Integer;
begin
  { block repeated renovation with the change in the dimensions of window, which
