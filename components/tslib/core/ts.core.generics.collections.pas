...
unit ts.Core.Generics.Collections experimental;
...
uses
    Classes, SysUtils, ts.Core.Generics.Defaults, ts.Core.Generics.Helpers;
...
type
  ...
  protected
    ...
    function DoGetEnumerator: ts.Core.Generics.Collections.TEnumerator<T>; override;
...
function TList<T>.DoGetEnumerator: ts.Core.Generics.Collections.TEnumerator<T>;
begin
...
function TQueue<T>.DoGetEnumerator: ts.Core.Generics.Collections.TEnumerator<T>;
begin
  Result := GetEnumerator;
end;
...
function TStack<T>.DoGetEnumerator: ts.Core.Generics.Collections.TEnumerator<T>;
begin
  Result := GetEnumerator;
end;
...
begin
  ...
  else if FItemsLength = $40000001 then // High(TIndex) ... System.Generics.Collections.pas(292,26) Error: Type mismatch
    OutOfMemoryError;
...
begin
  ...
  else if FItemsLength = TIndex.High then // High ... System.Generics.Collections.pas(292,26) Error: Type mismatch
    OutOfMemoryError
  else if FItemsLength = Result then
  begin
