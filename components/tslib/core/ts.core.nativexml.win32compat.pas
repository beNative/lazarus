...
uses
  SysUtils,
  // code from philo.de
  ts.Core.CodecUtilsWin32, ts.Core.NativeXml;
...
const
  ...
  ( (Name: 'IBM037';                  Codepage:    37; Codec: TIBM037Codec), //1
    ...
    (Name: 'ASMO-449+';               Codepage:   709; Codec: TUnicodeCodec),
    (Name: 'BCON V4';                 Codepage:   709; Codec: TUnicodeCodec),
    (Name: 'Arabic';                  Codepage:   710; Codec: TUnicodeCodec),
    (Name: 'DOS-720';                 Codepage:   720; Codec: TUnicodeCodec),
    ...
    (Name: 'gb2312';                  Codepage:   936; Codec: TUnicodeCodec),
    (Name: 'ks_c_5601-1987';          Codepage:   949; Codec: TUnicodeCodec),
    (Name: 'big5';                    Codepage:   950; Codec: TUnicodeCodec),
    ...
    (Name: 'Johab';                   Codepage:  1361; Codec: TUnicodeCodec),
    (Name: 'macintosh';               Codepage: 10000; Codec: TMacLatin2Codec),  //guess, maybe also TMacRomanCodec
    (Name: 'x-mac-japanese';          Codepage: 10001; Codec: TUnicodeCodec),
    (Name: 'x-mac-chinesetrad';       Codepage: 10002; Codec: TUnicodeCodec),
    (Name: 'x-mac-korean';            Codepage: 10003; Codec: TUnicodeCodec),
    (Name: 'x-mac-arabic';            Codepage: 10004; Codec: TUnicodeCodec),
    (Name: 'x-mac-hebrew';            Codepage: 10005; Codec: TUnicodeCodec),
    (Name: 'x-mac-greek';             Codepage: 10006; Codec: TMacGreekCodec),
    (Name: 'x-mac-cyrillic';          Codepage: 10007; Codec: TMacCyrillicCodec),
    (Name: 'x-mac-chinesesimp';       Codepage: 10008; Codec: TUnicodeCodec),
    (Name: 'x-mac-romanian';          Codepage: 10010; Codec: TUnicodeCodec),
    (Name: 'x-mac-ukrainian';         Codepage: 10017; Codec: TUnicodeCodec),
    (Name: 'x-mac-thai';              Codepage: 10021; Codec: TUnicodeCodec),
    (Name: 'x-mac-ce';                Codepage: 10029; Codec: TUnicodeCodec),
    (Name: 'x-mac-icelandic';         Codepage: 10079; Codec: TMacIcelandicCodec),
    (Name: 'x-mac-turkish';           Codepage: 10081; Codec: TMacTurkishCodec),
    (Name: 'x-mac-croatian';          Codepage: 10082; Codec: TUnicodeCodec),
    (Name: 'utf-32';                  Codepage: 12000; Codec: TUCS4_3412Codec),  //guess
    (Name: 'utf-32BE';                Codepage: 12001; Codec: TUCS4_2143Codec),  //guess
    (Name: 'x-Chinese_CNS';           Codepage: 20000; Codec: TUnicodeCodec),
    (Name: 'x-cp20001';               Codepage: 20001; Codec: TUnicodeCodec),
    (Name: 'x_Chinese-Eten';          Codepage: 20002; Codec: TUnicodeCodec),
    (Name: 'x-cp20003';               Codepage: 20003; Codec: TUnicodeCodec),
    (Name: 'x-cp20004';               Codepage: 20004; Codec: TUnicodeCodec),
    (Name: 'x-cp20005';               Codepage: 20005; Codec: TUnicodeCodec),
    (Name: 'x-IA5';                   Codepage: 20105; Codec: TUnicodeCodec),
    (Name: 'x-IA5-German';            Codepage: 20106; Codec: TUnicodeCodec),
    (Name: 'x-IA5-Swedish';           Codepage: 20107; Codec: TUnicodeCodec),
    (Name: 'x-IA5-Norwegian';         Codepage: 20108; Codec: TUnicodeCodec),
    (Name: 'us-ascii';                Codepage: 20127; Codec: TUSASCIICodec),
    (Name: 'x-cp20261';               Codepage: 20261; Codec: TUnicodeCodec),
    (Name: 'x-cp20269';               Codepage: 20269; Codec: TUnicodeCodec),
    (Name: 'IBM273';                  Codepage: 20273; Codec: TIBM273Codec),
    (Name: 'IBM277';                  Codepage: 20277; Codec: TIBM277Codec),
    (Name: 'IBM278';                  Codepage: 20278; Codec: TUnicodeCodec),
    ...
    (Name: 'IBM-Thai';                Codepage: 20838; Codec: TUnicodeCodec),
    ...
    (Name: 'IBM00924';                Codepage: 20924; Codec: TUnicodeCodec),
    (Name: 'EUC-JP';                  Codepage: 20932; Codec: TUnicodeCodec),
    (Name: 'x-cp20936';               Codepage: 20936; Codec: TUnicodeCodec),
    (Name: 'x-cp20949';               Codepage: 20949; Codec: TUnicodeCodec),
    (Name: 'cp1025';                  Codepage: 21025; Codec: TUnicodeCodec),
    (Name: 'koi8-u';                  Codepage: 21866; Codec: TUnicodeCodec),
    ...
    (Name: 'x-Europa';                Codepage: 29001; Codec: TUnicodeCodec),
    (Name: 'iso-8859-8-i';            Codepage: 38598; Codec: TISO8859_8Codec), //guess
    (Name: 'iso-2022-jp';             Codepage: 50220; Codec: TUnicodeCodec),
    (Name: 'csISO2022JP';             Codepage: 50221; Codec: TUnicodeCodec),
    (Name: 'iso-2022-jp';             Codepage: 50222; Codec: TUnicodeCodec),
    (Name: 'iso-2022-kr';             Codepage: 50225; Codec: TUnicodeCodec),
    (Name: 'x-cp50227';               Codepage: 50227; Codec: TUnicodeCodec),
    (Name: 'euc-jp';                  Codepage: 51932; Codec: TUnicodeCodec),
    (Name: 'EUC-CN';                  Codepage: 51936; Codec: TUnicodeCodec),
    (Name: 'euc-kr';                  Codepage: 51949; Codec: TUnicodeCodec),
    (Name: 'hz-gb-2312';              Codepage: 52936; Codec: TUnicodeCodec),
    (Name: 'GB18030';                 Codepage: 54936; Codec: TUnicodeCodec),
    (Name: 'x-iscii-de';              Codepage: 57002; Codec: TUnicodeCodec),
    (Name: 'x-iscii-be';              Codepage: 57003; Codec: TUnicodeCodec),
    (Name: 'x-iscii-ta';              Codepage: 57004; Codec: TUnicodeCodec),
    (Name: 'x-iscii-te';              Codepage: 57005; Codec: TUnicodeCodec),
    (Name: 'x-iscii-as';              Codepage: 57006; Codec: TUnicodeCodec),
    (Name: 'x-iscii-or';              Codepage: 57007; Codec: TUnicodeCodec),
    (Name: 'x-iscii-ka';              Codepage: 57008; Codec: TUnicodeCodec),
    (Name: 'x-iscii-ma';              Codepage: 57009; Codec: TUnicodeCodec),
    (Name: 'x-iscii-gu';              Codepage: 57010; Codec: TUnicodeCodec),
    (Name: 'x-iscii-pa';              Codepage: 57011; Codec: TUnicodeCodec),
    (Name: 'utf-7';                   Codepage: 65000; Codec: TUnicodeCodec),
...
begin
  if CodePage = 65001 then
    // utf-8
    Result := sdWideToUtf8Buffer(lpWideCharStr^, lpMultiByteStr^, cchWideChar, B)
  else
  begin
    CodecClass := nil;
    for i := 0 to cCodepageToEncodingInfoCount - 1 do
