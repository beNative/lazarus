...
uses
  ...
  ts.Editor.Interfaces, ts.Editor.Resources, ts.Editor.Highlighters,
  ts.Editor.View,
...
type
  ...
  private
    ...
    FToolViewManager : TToolViewManager;
...
{$ENDIF}
  ...
  ts.Core.Utils, ts.Core.ComponentInspector,

  ts.Editor.Settings, ts.Editor.HighlighterAttributes,
  ts.Editor.SettingsDialog.Old, ts.Editor.Utils,

  ts.Editor.ToolView.ViewList,
  ts.Editor.ToolView.CodeShaper,
  ts.Editor.ToolView.Preview,
  ts.Editor.ToolView.Test,
  ts.Editor.ToolView.Search,
  ts.Editor.ToolView.Shortcuts,
  ts.Editor.ToolView.ActionList,
  ts.Editor.ToolView.CodeFilter,
  ts.Editor.ToolView.CharacterMap,
  ts.Editor.ToolView.Structure,
  ts.Editor.ToolView.AlignLines,
  ts.Editor.ToolView.HTMLView,
  ts.Editor.ToolView.HexEditor,
  ts.Editor.Toolview.Minimap,
  ts.Editor.ToolView.ScriptEditor,

  ts.Editor.AboutDialog, ts.Editor.CodeFormatters, ts.Editor.CodeFormatters.SQL,

  ts.Editor.SearchEngine, ts.Editor.ToolView.SelectionInfo,
...
begin
  ...
  FToolViewManager := TToolViewManager.Create(Self);
...
var
  ETV: IEditorToolView;
begin
  ETV := FToolViewManager.FindByName('CodeFilter');
...
begin
  ...
  FToolViewManager.Register(TfrmSearchForm, 'Search');
  FToolViewManager.Register(TfrmViewList, 'ViewList');
  FToolViewManager.Register(TfrmPreview, 'Preview');
  FToolViewManager.Register(TfrmActionListView, 'ActionListView');
  FToolViewManager.Register(TfrmTest, 'Test');
  FToolViewManager.Register(TfrmAlignLines, 'AlignLines');
  FToolViewManager.Register(TfrmCodeFilterDialog, 'CodeFilter');
  FToolViewManager.Register(TfrmSelectionInfo, 'SelectionInfo');
  FToolViewManager.Register(TfrmStructure, 'Structure');
  FToolViewManager.Register(TfrmCharacterMap, 'CharacterMap');
  FToolViewManager.Register(TfrmHTMLView, 'HTMLView');
...
begin
  ...
  if AVisible then
  begin
    ETV := FToolViewManager.FindByName(AName);
    DoShowToolView(ETV);
    ETV.Visible := True;
    ETV.UpdateView;
    if ASetFocus then
