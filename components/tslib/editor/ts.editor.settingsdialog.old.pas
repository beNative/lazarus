...
uses
  ...
  RTTIGrids, PropEdits, ButtonPanel,
...
type
  ...
  TfrmEditorSettings = class(TForm)
    ...
    procedure FPIFilter(Sender: TObject; aEditor: TPropertyEditor;
      var aShow: boolean);
...
begin
  ...
  FPI.OnEditorFilter   := FPIFilter;
  FHAPI.OnEditorFilter := FPIFilter;
  FHLPI.OnEditorFilter := FPIFilter;
  UpdateData;
...
procedure TfrmEditorSettings.FPIFilter(Sender: TObject;
