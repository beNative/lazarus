...
unit ts_Editor_ToolView_AlignLines;
...
uses
  Classes, SysUtils, FileUtil, ts_components_multipanel, Forms, Controls, Graphics, Dialogs,
  ...
  ts_Editor_Interfaces, ts_Editor_Settings_AlignLines, ts_Editor_ToolView_Base,
