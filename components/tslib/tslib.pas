...
uses
  ...
  ts_Editor_SynHighlighterCollection, ts_Core_DataTemplates, 
  ts_Core_TreeViewPresenter, ts_RichEditor_Manager, ts_RichEditor_View, 
  ts_Docking, ts_Docking_OptionsDialog, ts_Docking_Storage, 
  ts_Docking_Resources, ts_Editor_PreviewForm, ts_Core_XMLUtils, 
  ts_Core_ColumnDefinitions, ts_Core_ColumnDefinitionsDataTemplate, 
  ts_Core_DBUtils, ts_Core_DirectoryWatch, ts_Core_FormSettings, 
  ts_Core_KeyValues, ts_Core_Utils, ts_Core_VersionInfo, 
  ts_RichEditor_Helpers, ts_RichEditor_Interfaces, 
