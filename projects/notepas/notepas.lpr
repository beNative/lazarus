...
{$ENDIF}
  ...
  ts.Core.DataTemplates, tslib_components, tslib_core, tslib_editor,
  ts.Components.Docking, ts.Editor.AboutDialog, ts.Editor.CodeFormatters,
  ...
  ts.Editor.Factories.Menus, ts.Editor.Factories, ts.Editor.Factories.Settings,
